...
autoplot(tm) + ggtitle("push and pop 1000 times")
```
...
tm <- microbenchmark(
    ...
    fastmap = test_fastmap_dict_set_get(100),
    base = test_collections_dictl_set_get(100),
...
tm <- microbenchmark(
    hash = test_hash_dict_set_get(1000),
    fastmap = test_fastmap_dict_set_get(1000),
    collections = test_collections_dict_set_get(1000),
    unit = "relative"
)
autoplot(tm) + ggtitle("set and get 1000 times")
```
