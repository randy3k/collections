...
```{r, echo = FALSE}
test_collections_naive_ordered_dict_set_get <- function(n) {
    h <- collections::NaiveOrderedDict$new()
    for (i in 1:n) h$set(as.character(i), rnorm(1))
...
microbenchmark(
    ...
    collections_array = test_collections_naive_ordered_dict_set_get(100),
    times = 10,
    unit = "relative"
)
microbenchmark(
    collections = test_collections_ordered_dict_set_get(1000),
    collections_array = test_collections_naive_ordered_dict_set_get(1000),
    times = 10,
    unit = "relative"
)
```
